...
* [Notify all the 3rd parties (see reference in the 'Kick-off phase)]( {{site.baseurl}}/guide/kick-off#notifying-third-parties-and-links) and services to switch off links/communications 1-2 days prior to Final Data Production day. As highlighted in the Kick-off and Pre-migration Tasks stages.
