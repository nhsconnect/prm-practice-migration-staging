...
* [Notify all the 3rd parties] (/prm-practice-migration/guide/kick-off#notification-of-3rd-parties-and-links) (see reference in the 'Kick-off' page) and services to switch off links/communications 1-2 days prior to Final Data Production day. As highlighted in the Kick-off and Pre-migration Tasks stages.
