...
If you have followed any manual processes during Cutover that you established during the [Cutover planning phase]( {{site.baseurl}}/guide/planning-for-cut-over#best-practices-for-cutover), you can now start the task of re-entering the data captured.
