...
If you have followed any manual processes during Cutover that you established during the [Cutover planning phase](/prm-practice-migration/guide/planning-for-cut-over#best-practices-for-cutover), you can now start the task of re-entering the data captured.
...
The process for submitting these reports to NHS under GP IT Futures is currently being finalised. As soon as the new process is ready, we will let you know. 
{%- endcapture -%}
