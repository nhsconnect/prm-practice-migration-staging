...
* The practice has identified the patient records matching criteria provided by the new supplier for testing  ([see Pre-migration tasks]( {{site.baseurl}}/guide/pre-migration-tasks#data-checking-prep))
